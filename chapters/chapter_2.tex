...
Alle genannten und ungenannte Repräsentationsverfahren werden in der Praxis einzeln oder in Kombination eingesetzt. Die große Herausforderung besteht vor allem im Segmentieren des Objekts in der gewählten Repräsentationen. Je nach Anwendungsfall ist eine solche Berechnung technisch einfach oder kompliziert zu realisieren. Einige Verfahren werden nun kurz vorgestellt.
